...
monkey_business = run_rounds(lines, 20, 3)
...
in fact, that your relief that a monkey's inspection didn't damage an 
...
from reaching ridiculous levels. You'll need to find another way to keep your worry levels manageable.
